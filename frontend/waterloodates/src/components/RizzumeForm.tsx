...
const RizzumeForm = forwardRef<RizzumeFormRef, RizzumeFormProps>(({ onSubmit, onCancel, initialData, viewMode }, ref) => {
    ...
    const [uploadedImageId, setUploadedImageId] = useState<string>(initialData?.profile?.pfp_url || 'y1nklwuj9npfrkjzpxos')
    const [imageUrl, setImageUrl] = useState<string>(
        initialData?.profile?.pfp_url
            ? `https://res.cloudinary.com/${cloudName}/image/upload/${initialData.profile.pfp_url}`
            : `https://res.cloudinary.com/${cloudName}/image/upload/y1nklwuj9npfrkjzpxos`
    )
    ...
    const handleSubmit = (e?: any) => {
        ...
        // Structured data according to MongoDB schema
...
RizzumeForm.displayName = 'RizzuméForm'

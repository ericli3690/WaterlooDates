...
def create_or_update_interview():
    try:
        ...
        if not existing_application or not existing_applicant_user or not existing_interviewer_user or not existing_wingman or not existing_applicant_rizzume or not existing_interviewer_rizzume:
            ...
            print("existing applicant user: ", existing_applicant_user)
            print("existing interviewer user: ", existing_interviewer_user)
            print("existing wingman: ", existing_wingman)
            print("existing applicant rizzume: ", existing_applicant_rizzume)
            print("existing interviewer rizzume: ", existing_interviewer_rizzume)
